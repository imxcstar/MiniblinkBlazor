...
namespace BlazorHybridMiniblinkExample
{
    public class MiniblinkWebViewManager : WebViewManager
    {
        ...
        protected override void SendMessage(string message)
        {
            try
            {
                Program.logger.Debug($"MiniblinkWebViewManager_SendMessage: {message}");
            ...
            {
                Program.logger.Debug($"MiniblinkWebViewManager_SendMessage(ERROR): {ex.Message}");
            }
        }
        ...
        {
            Program.logger.Debug($"MessageReceived({_appBaseUri}): {message}");
